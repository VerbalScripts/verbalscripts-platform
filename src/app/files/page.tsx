  ...
  return (
    <div className='bg-white'>
      ...
      <div className='flex flex-col items-center justify-center h-screen'>
        <FileUploadOptions />
        <p className=' text-5xl text-gray-600 mb-12'>Upload File</p>

        <div className='mb-5'>
          <span className='text-gray-800 font-semibold'>
            Supported File Formats:
          </span>{' '}
          {supportedFormats.map((fileFormat, index) => (
            <span className='text-base text-gray-700' key={index}>
              {fileFormat}
              {', '}
            </span>
          ))}
        ...
        <div className='relative w-1/3 rounded-md ring-1 ring-inset ring-gray-300  h-2/3 bg-gray-200'>
          <div className='flex flex-col items-center'>
            <img
              src='drag-n-drop.svg'
              alt=''
              className='absolute top-6  w-24'
            />

            <p className='text-base mt-24 font-semibold text-gray-600'>
