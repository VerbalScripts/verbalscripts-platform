...
import {
  ...
  MicrophoneIcon,
  PowerIcon,
  ChartBarIcon, LockClosedIcon,
  CurrencyDollarIcon,
  ClockIcon,
  CalendarIcon
} from '@heroicons/react/24/outline'

import { ChevronDownIcon, PhoneIcon, PlayCircleIcon, StarIcon } from '@heroicons/react/20/solid'
...
const solutions = [
  { name: 'Medical & Research', description: 'We have experienced, dedicated teams of workers who specialize in healthcare related content who provide accurate and confidential transcriptions for both our Medical and HIPAA-compliant services.', href: '/medical', icon: ChartPieIcon },
  { name: 'Legal', description: 'We convert audio/video content into transcripts quickly and securing to save law firms, investigators, police force, or research firms time and money.', href: '/legal', icon: NewspaperIcon },
  { name: 'AI Machine Learning', description: 'The very best in human intelligence requires top quality training data for speech NLP and computer vision models.', href: '/ai', icon: FingerPrintIcon },
  { name: 'Education', description: 'Fast, easy lecture and dissertation transcripts for students or faculty, compatible with NVivo and other research platforms.', href: '/academic', icon: AcademicCapIcon },
  { name: 'Market Research', description: 'Transcription that is perfect for all types of qualitative research needs, including focus groups, surveys and in-depth interviews.', href: '/market-research', icon: ChartBarIcon },
  { name: 'Enterprise', description: 'Customized for your large volume needs, including a variety of enterprise security requirements.', href: '/enterprise', icon: ArrowPathIcon },
  { name: 'Technology', description: 'Analyze interviews, focus groups, and data mine content to turn your qualitative audio content into quantitative text.', href: '/technology', icon: PowerIcon },
  { name: 'Consulting', description: 'Fast transcription and research data to meet due diligence and management consulting research needs.', href: '/consulting', icon: SquaresPlusIcon },
  { name: 'Call Centers', description: 'Automated speech recognition & analytics for call centers', href: '/call-centers', icon: MicrophoneIcon },
]
...
const resources = [
  ...
  { name: 'Policies', description: 'check valid policies', href: '/policies', icon: ChartPieIcon },
    ...
    {
    description: " “TranscribeMe has allowed me to maintain a flexible schedule...this gives me the freedom to be able to work when I want to.” ",
    ...
    years: '3',
      ...
      {
    description: " “I can work my work around what I need to do for myself which is fantastic...TranscribeMe is the perfect place for me to work.” ",
    name: "Suzanne Thomas",
    imageUrl: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",
      state: 'Florida',
    ...
    years: '3',
        ...
        {
    description: " “I’ve loved every second of it. I love to work when I want to work and not work when I don’t feel like working.” ",
    ...
    years: '2',
        ...
        {
    description: " “The community’s really supportive, it feels like kind of an online family and it’s really nice to be a part of.”",
    name: "Nicole Shafer",
    imageUrl: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",
       state: 'Utah',
    years: '4',
    ...
    return (
      ...
      >
        <FreelancingHeader resources={resources} solutions={solutions} services={services} heightOffset={heightOffset } />
        ...
        <div className="mx-auto max-w-2xl lg:text-center px-6 sm:py-32 lg:px-8">
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative md:pl-16 ">
                <dt className="flex flex-col items-center ">
                  <div className="text-center  mb-3 flex h-20 w-20 items-center justify-center rounded-lg bg-indigo-900/10">
                    <feature.icon className="h-14 w-14 text-indigo-900" aria-hidden="true" />
                  </div>
                  <span className='text-md uppercase  leading-7 text-indigo-600' >
                    {feature.name}
                  </span>
                </dt>
                <dd className="text-center my-5 text-6xl font-bold leading-6 text-indigo-800">{feature.description}</dd>
                <dd className="text-center mt-3 text-md leading-6 text-indigo-600">{feature.subtitle}</dd>
              </div>
            ))}
          </dl>
        </div>
          ...
          <p className="mt-24 mb-5 text-xl leading-8 text-gray-600">
            We also offer advancement opportunities for our Special Teams that include Medical and Specialty Styles, which pay even higher rates!
                ...
                <a href="#" className='text-orange-500 font-semibold text-lg underline underline-offset-4'>Learn More About Freelancing</a>
    ...
    <div className="bg-gray-200">
         ...
         Our freelance jobs allow you to earn money from anywhere you’d like, while paying you competitively and providing career growth opportunities.         </p>
          ...
          <div className="lg:mx-0 lg:flex-auto lg:py-32 text-left">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-700">
                                ...
                                <div className='mt-5'>
                <a href="#" className='text-orange-500 font-semibold text-lg underline underline-offset-4'>More About the Work</a>
          ...
          <div className="mx-auto max-w-xl  lg:mx-0 lg:flex-auto lg:py-32">
            ...
            <h2 className="text-2xl font-bold  text-gray-800 sm:text-4xl">
                    ...
                    Gain insight into various industries and boost your resume for any job market. Develop your skills, and grow into higher-paying projects and positions.
                                 ...
                                 <div className='mt-5'>
                <a href="#" className='text-orange-500 font-semibold text-lg underline underline-offset-4'>Start Freelancing</a>
    ...
    <div className="mx-auto mt-16 max-w-3xl sm:mt-20 lg:mt-24 lg:max-w-5xl">
          <dl className="mx-auto grid max-w-none  grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10 lg:max-w-7xl xl:max-w-7xl lg:gap-y-16">
            {[...testimonials].map((feature) => (
             <dl  key={feature.name} className="relative  transition  bg-white shadow-md rounded-lg px-5 py-8 md:px-8 md:py-14">
                <dt className="flex  leading-7 text-gray-200">
                     <StarIcon className="h-8 w-8 text-indigo-600" aria-hidden="true" />
                     <StarIcon className="h-8 w-8 text-indigo-600" aria-hidden="true" />
                     <StarIcon className="h-8 w-8 text-indigo-600" aria-hidden="true" />
                     <StarIcon className="h-8 w-8 text-indigo-600" aria-hidden="true" />
                     <StarIcon className="h-8 w-8 text-indigo-600" aria-hidden="true" />
                 </dt>
                    <dd className="mt-2 text-xl leading-7 text-gray-700">{feature.description}</dd>
                    <dd className="mt-5 flex items-center gap-x-5">
                        ...
                        <div className="">
                            ...
                            <div className="text-gray-300 text-sm">{ feature.state }</div>
                        </div>
                    </dd>
              </dl>
            ))}
          ...
          <p className="mt-2 text-4xl font-bold leading-10 text-gray-900 sm:text-4xl">
                  ...
                  <div className='flex md:block'>
                    ...
                    <br />
                    <div className='ml-5 leading-6 max-w-[20rem] md:max-w-[10rem] lg:max-w-[15rem] md:text-center md:-ml-20 lg:-ml-28'>
                                    <div className='text-xl md:text-lg lg:text-xl font-semibold text-gray-600'>Take the  Entrance Exam.</div>
                                     <div className='text-gray-600'>
