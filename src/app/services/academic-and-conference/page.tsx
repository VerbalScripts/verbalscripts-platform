  ...
  return (
    <div className='bg-zinc-800  relative'>
      ...
      <div className='py-10 md:py-16 why-academic-section-bg '>
        <div className='mx-auto max-w-7xl    px-6 py-5 md:px-16 lg:px-16 xl:px-24'>
          <div className='flex flex-wrap lg:flex-nowrap items-center gap-x-6 rounded-md md:px-8 md:py-10 bg-white/50 ring-1 ring-white/10'>
