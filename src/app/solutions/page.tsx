  ...
  <div className="mx-auto max-w-2xl lg:text-center ">
          ...
          <dl className="mx-auto grid max-w-none px-6 grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10 lg:max-w-7xl xl:max-w-7xl lg:grid-cols-2 lg:gap-y-16">
            {[...solutions].map((feature) => (
             <a href={'/solutions' + feature.href} key={feature.name} className="relative pl-16 transition  hover:bg-white/5 hover:-translate-y-5 hover:ring-1 hover:ring-white/10 rounded-lg p-4">
                ...
                <dd className="mt-1 text-lg leading-7 text-gray-700">{feature.description}</dd>
                <p className='text-orange-500 font-semibold text-lg underline underline-offset-4'>Learn More</p>
              </a>
            ))}
          </dl>
          </div>
