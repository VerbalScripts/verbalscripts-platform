                ...
                <Dialog.Panel className="pointer-events-auto relative w-screen max-w-md">
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                    <div className="px-4 sm:px-6">
                      <Dialog.Title className="text-xl font-semibold leading-6 text-gray-600">
                        Request a Quotation
                      </Dialog.Title>
                    </div>
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              ...
              <div>
                  <label htmlFor="password" className="block text-md font-medium leading-6 text-gray-900">
                    You can add more information to allow us to identify your situation
                  </label>
                ...
                <div className="mt-2">
                  <textarea
                    ...
                    rows={4}
                    required
                    className="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-600 text-md sm:leading-6"
                  />
                </div>
              </div>
