        ...
        <div className='fixed inset-0 overflow-hidden'>
          <div className='absolute inset-0 overflow-hidden'>
            <div className='pointer-events-none fixed inset-y-0 right-0 flex max-w-full '>
              ...
              >
                <Dialog.Panel className='pointer-events-auto relative w-screen bottom-0 mt-32'>
                  <Transition.Child
                    as={Fragment}
                    enter='ease-in-out duration-500'
                    enterFrom='opacity-0'
                  ...
                  <div className='flex h-full flex-col overflow-y-scroll rounded-t-xl bg-white py-14 shadow-xl'>
