...
export default function LandingPage() {
  return (
    <div className='relative bg--600 h-auto isolate px-6 lg:px-8 bg-indigo-500 landing-page'>
      ...
      <div className='max-w-7xl md:py-16 lg:py-28 xl:py-32 py-20 md:mx-10 lg:mx-20 xl:mx-28 flex flex-col items-start md:items-center  text-left lg:text-center'>
