    ...
    <Transition.Root show={open} as={Fragment}>
      <Dialog as='div' className='relative z-50' onClose={setOpen}>
        <Transition.Child
          ...
          leaveTo='opacity-0'
        >
          <div className='fixed inset-0 hidden opacity-0   md:block' />
        </Transition.Child>
        ...
        <div className='fixed inset-0 z-10 w-screen overflow-y-auto'>
          <div className='flex  items-stretch justify-center text-center md:items-center md:px-2 lg:px-4'>
            <Transition.Child
              as={Fragment}
              enter='ease-out duration-300'
              enterFrom='opacity-0 ranslate-y-4 md:translate-y-0 md:scale-95'
            ...
            >
              <Dialog.Panel className='flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl'>
                <div
                  className='absolute -right-56 top-5 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white  divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl'
