  ...
  return (
    <div
      className={classNames(
        ...
        showToast ? 'block toast-render' : 'hidden toast-hide',
      )}
    >
      <Toast className='flex flex-col py-0 px-0 max-w-none'>
        ...
        <div
          className={classNames(
            'flex flex-col gap-y-2 transition-all h-0 duration-150  w-full',
            !open ? 'overflow-y-hidden' : 'h-[20rem] overflow-y-auto',
          )}
        >
          {_progressTracker.length > 0 && filesToUpload.length > 0
            ? filesToUpload.map((file, index) => (
                <div
                  ...
                  className={classNames(
                    ...
                    uploadStats.complete == uploadStats.total ? 'hidden' : '',
                  )}
                >
          ...
          >
            ...
            <div className='mt-1 text-center text-gray-700 font-semibold'>
              Upload Complete
            </div>
          </div>
        </div>
