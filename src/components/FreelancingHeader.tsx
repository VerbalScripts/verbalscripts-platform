...
export default function Freelanc({solutions, resources, services, heightOffset}: HeaderProps) {
  ...
  <a href="/" className="text-md font-semibold leading-6 text-gray-900">
          What’s Work Like?
            ...
            Freelancer FAQs
                      ...
                      <a href="#" className=" text-lg font-semibold  px-4 py-2 bg-indigo-500 transition text-center  hover:-translate-y-1 hover:shadow-xl rounded-md text-white">
          Freelancer Login
          </a>
        </Popover.Group>
      </nav>
