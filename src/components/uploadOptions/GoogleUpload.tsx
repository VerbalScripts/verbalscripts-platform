...
interface GoogleUploadRef {
  launchPicker?: () => void;
}

const GoogleUpload = forwardRef<GoogleUploadRef, GoogleUploadProps>(
  ({ visible = true }, ref) => {
          ...
          <div>
            <div className='px-6 py-10 lg:py-12'>
              ...
              <p className='text-gray-600'>
                ...
                laudantium consequatur magni est similique praesentium
                accusantium culpa molestiae enim iure.
              </p>
